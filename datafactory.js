...
function chatGenerator(index) {
    const names = ["Varsha", "Vyhnavi", "Bhavana", "Harika", "Jahnavi", "Jaya", "Sai", "Janu", "Santhosh", "Priya", "Mishti", "Tara", "Swapna", "Milli", "Sheethal", "John", "Meera", "Nithya", "Kiana", "Sandy", "Maggy", "Lilly", "Radha", "Sita", "Siya", "Krishna", "Virat", "Rithu", "Apple", "Kriti", "Ramya", "Pihu"]
